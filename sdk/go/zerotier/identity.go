...
func NewIdentity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("zerotier:index/identity:Identity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIdentity(ctx *pulumi.Context,
	...
	var resource Identity
	err := ctx.ReadResource("zerotier:index/identity:Identity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
