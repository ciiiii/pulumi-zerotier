...
class _IdentityState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] private_key: The private key of the identity.
        :param pulumi.Input[str] public_key: The public key of the identity.
        """
...
class Identity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            private_key: Optional[pulumi.Input[str]] = None,
            public_key: Optional[pulumi.Input[str]] = None) -> 'Identity':
        """
