...
namespace Pulumi.Zerotier
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Zerotier.version.txt");
    ...
    internal sealed class ZerotierResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public ZerotierResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
