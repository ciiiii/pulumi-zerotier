...
import (
	...
	"github.com/terraform-providers/terraform-provider-zerotier/zerotier"
)
...
const (
	...
	mainPkg = "zerotier"
	// modules:
	mainMod = "index" // the zerotier module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv2.NewProvider(zerotier.Provider())
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"pulumi", "zerotier", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/pulumi/pulumi-zerotier",
